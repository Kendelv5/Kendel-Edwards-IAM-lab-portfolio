...
| :---: | :--- | :--- | :--- |
| **01** | [Automated Lifecycle Management]([./01-Lifecycle-Management/](https://github.com/Kendelv5/.-01-Lifecycle-Management-)) | Okta, Expression Language | Automated contractor provisioning and group assignment using custom attribute rules. |
